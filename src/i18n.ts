...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    opening: "Opening",
    contact_sensor: "Contact sensor (window / door)",
    cover_entity: "Cover",
    ...
    invert: "Invert",
    unavailable: "When unavailable / no value",
    below: "Below",
    above: "Above",
    severity: "Severity",
  ...
  de: {
    ...
    show_opening_icon: "Icon anzeigen",
    ...
    opening: "Öffnung",
    contact_sensor: "Kontaktsensor (Fenster / Tür)",
    ...
    invert: "Invertieren",
    unavailable: "Bei nicht verfügbar / kein Wert",
    below: "Unter",
    above: "Über",
    ...
    width_full: "Voll",
    width_half: "Halb",
    style_default: "Standard (Sektion)",
